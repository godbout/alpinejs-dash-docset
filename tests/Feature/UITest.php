...
class UITest extends TestCase
{
    ...
    {
        $leftSidebar = 'fixed pb-6 pt-8 px-8 left-0 bottom-0 hidden md:block w-48 lg:w-64';
    ...
    {
        $rightSidebar = 'fixed py-8 px-6 right-0 bottom-0 w-64 overflow-y-auto hidden xl:block';
